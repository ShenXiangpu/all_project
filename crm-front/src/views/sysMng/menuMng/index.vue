<template>
  <div class="app-container">
    ...
    <el-card>
      <template #header>
        <el-button
          v-permission="['system:menu:saveMenu']"
          type="primary"
          icon="el-icon-plus"
          @click="handleAdd({})"
          >新增</el-button
      ...
      >
        ...
        <el-table-column
          v-if="
            checkPermission([
              'system:menu:saveMenu',
              'system:menu:updMenu',
              'system:menu:delMenus',
            ])
          "
          label="操作"
          fixed="right"
        ...
        >
          <template #default="scope">
            ...
            <el-button
              v-permission="['system:menu:updMenu']"
              size="small"
              type="primary"
            ...
            >
              <el-button
                v-permission="['system:menu:delMenus']"
                size="small"
                type="danger"
                class="editDanger marginleft10"
                slot="reference"
              >
                删除
              </el-button>
