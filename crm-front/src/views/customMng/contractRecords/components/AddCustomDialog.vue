  ...
  >
    <el-form ref="form" class="el-form-edu" :model="form" :rules="rules">
      ...
      <el-row>
        ...
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
          <el-form-item label="服务生效时间" prop="name">
            <el-date-picker
              v-model="form.packageType"
              class="el-input-edu"
              type="date"
        ...
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
          <el-form-item label="服务结束时间" prop="name">
            <el-date-picker
              v-model="form.packageType"
              class="el-input-edu"
              type="date"
        ...
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
          <el-form-item label="付款状态" prop="name">
            <el-select
              class="el-input-edu"
              v-model="form.packageType"
              placeholder="请选择付款状态"
        ...
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
          <el-form-item label="成交金额" prop="name">
            <el-input
              class="el-input-edu"
              placeholder="请输入成交金额"
              v-model="form.name"
      ...
      <div class="marginBottom20 font16 fontW7">
        <span class="primaryColoro">*</span> 其他文件
      </div>
      <el-row>
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
          <el-form-item label="上传合同" prop="name">
