<template>
  <el-card>
    <el-table border :data="tableData" style="width: 100%" maxHeight="300" v-loading="loading">
      <el-table-column prop="contractName" label="合同名称" min-width="120" align="center" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="contractSe" label="合同序号" min-width="100" align="center" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="contractNo" label="合同编号" min-width="100" align="center" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="contractAmount" label="合同金额(元)" align="center" min-width="120" show-overflow-tooltip>
        <template #default="scope">
          <span>{{ scope.row.contractAmount }}</span>
        </template>
      </el-table-column>
      <el-table-column prop="paymentStatus" label="付款状态" align="center" min-width="100">
        <template #default="scope">
      ...
      <el-table-column prop="startTime" label="生效时间" align="center" min-width="100" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="endTime" label="结束时间" align="center" min-width="100" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="userName" label="跟进人" align="center" min-width="100" show-overflow-tooltip>
      </el-table-column>
