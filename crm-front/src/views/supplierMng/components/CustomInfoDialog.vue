<template>
  <el-dialog append-to-body :title="textMap[dialog.status]" :visible.sync="dialog.visible" class="el-dialog-edu"
      ...
      <el-row>
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
          <el-form-item label="供应商名称" prop="customerName">
            <el-input class="el-input-edu" placeholder="请输入供应商名称" v-model="form.customerName" maxlength="40"
    ...
    <el-form ref="followForm" class="el-form-edu" :model="followFormData" :rules="followRules"
      ...
      <div class="marginBottom20 font16 fontW7">
        <span class="primaryColoro">*</span> 供应商跟进
      </div>
      <el-row>
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
...
import { editOne, addCustomerFollowUp } from "@/api/crm/customMng";
