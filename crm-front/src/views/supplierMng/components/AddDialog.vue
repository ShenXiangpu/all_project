      ...
      <el-row>
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
          <el-form-item label="供应商名称" prop="customerName">
            <el-input class="el-input-edu" placeholder="建议输入为公司名称" v-model="form.customerName" maxlength="40"
        ...
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
          <el-form-item label="联系电话" prop="linkPhone">
            <el-input class="el-input-edu" placeholder="请输入联系电话" v-model="form.linkPhone" maxlength="40"
              show-word-limit></el-input>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
        ...
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
          <supplier-type className="el-input-edu" :form="form" />
        </el-col>
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
          <cooperation-type className="el-input-edu" :form="form" />
        </el-col>
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
...
import { addOne, editOne } from "@/api/crm/supplier";
...
import CooperationType from "@/views/clueMng/components/FormItem/CooperationType.vue";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        location: [{ required: true, message: "请选择所属地区", trigger: "blur" }],
        fullAddress: [
        ...
        trackUserId: [
          { required: true, message: "请选择跟踪人", trigger: "blur" },
        ],
      },
      fileList: [],
      visibleDialog: false,
