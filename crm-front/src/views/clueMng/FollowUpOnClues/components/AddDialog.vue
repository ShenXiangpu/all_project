...
import { addOneClue, editOneClue } from "@/api/crm/myClues";
    ...
    submitUpload() {
      this.$refs["form"].validate((valid) => {
        ...
        if (valid) {
          ...
          if (form.customerLabel) {
            form.customerLabel = this.tags.join(",");
          }
          if (form.location) {
