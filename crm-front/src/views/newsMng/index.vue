  ...
  <div>
    ...
    <el-card class="marginTop10">
        ...
        <div style="display: flex; justify-content: space-between">
          <div>
            <el-button
              ...
              >标记为已读</el-button
            >
            <el-button type="primary" icon="el-icon-plus" @click="readAll"
              >全部标记为已读</el-button
            >
          </div>
          <div>
      ...
      >
        ...
        >
          <template #default="scope">
            <div v-if="scope.row.msgType == 0" style="color: sandybrown">
              通知
            </div>
  ...
  methods: {
    ...
    getList() {
      ...
      queryNewsList(this.listQuery).then((reponse) => {
        ...
        this.newsList = resData && resData.records;
