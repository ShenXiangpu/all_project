<template>
  <div class="navbar">
    ...
    <broadcast
      class="el-broadcast-container"
      v-if="noticeData[2] && noticeData[2].length > 0"
      :msgList="noticeData[2]"
    />
    <div class="right-menu">
      <!-- <template v-if="roleId == '3' || roleId == '42'">
        <el-popover popper-class="el-popover-edu" trigger="click">
          <div>
            <settings />
          </div>
          <div class="primaryColor pointer" slot="reference">
            <i class="el-icon-magic-stick"></i> 主题风格
          </div>
        </el-popover>
      </template> -->

      <!-- <div class="primaryColor pointer marginRight20" @click="toManual">
        <el-divider
          v-if="roleId == '3' || roleId == '42'"
          direction="vertical"
        ></el-divider>
        <i class="el-icon-document"></i> 操作手册
        ...
        <el-dropdown trigger="click">
          <span class="el-dropdown-link" @click="initActive">
            <el-badge
              ...
              class="item"
            >
              <i class="el-icon-bell font20 pointer"></i>
            </el-badge>
          </span>
          <el-dropdown-menu slot="dropdown" class="el-dropdown-menu-edu">
            ...
            >
              ...
              <el-tab-pane :label="`广播（${unreadMsg[2] || 0}）`" name="third">
                <div
                  v-if="noticeData && noticeData[2] && noticeData[2].length > 0"
                  class="tab-container"
                >
                  <div class="tab-container-content">
                    <div
                      ...
                      class="tab-container-item"
                      :class="item.msgStatus == 1 ? 'colord' : ''"
                      v-for="(item, index) in noticeData[2]"
                      :key="index"
                    >
                      <div class="tab-container-item-title font14">
                        {{ item.msgTitle }}
                  ...
                  <div @click="goToMore" class="tab-container-more text-center font14">
                    查看更多
                  </div>
                </div>
                <div
      ...
      <el-dropdown class="avatar-container pointer" trigger="click">
...
export default {
  ...
  methods: {
    ...
    goToDetail(id) {
      // window.location.href = `/newsAndBroadcast/newsDetail?id=${id}`;
      this.$router.push({ path: '/newAndBroadcast/newAndBroadcast' });
    },
    goToNewBroadcast() {
