      ...
      <div class="login-container-right">
        <el-form v-if="!isShowPhoneLogin" ref="loginForm" :rules="loginRules" :model="loginForm" class="login-form"
          ...
          <div class="title-container">
            <div class="iot-logo">{{ title || '中科教学实训平台' }}</div>
          ...
          <el-form-item prop="username">
            ...
            <el-input v-model="loginForm.username" placeholder="请输入手机号或者学/工号"  auto-complete="on"
...
<script>
import { getSmsCode, checkVerify } from "@/api/login";
...
export default {
  ...
  mounted() {
    const loginInfo = Cookies.getJSON("passObj");
    if (loginInfo) {
  ...
  .login-container {
    ...
    .title-container {
      ...
      &::before {
        ...
        background-repeat: no-repeat;
        background-image: url("../../assets/img/loginbg/logo.jpg");
      }
