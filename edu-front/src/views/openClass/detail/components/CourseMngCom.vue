...
<script>
import SXTree from '@/views/classMng/courseMng/courseDetail/components/SXTree/index.vue';
import ChapterDialog from './ChapterDialog.vue'
import UploadDialog from '@/views/classMng/courseMng/courseDetail/components/UploadDialog.vue'
import DetailDrawer from '@/views/classMng/courseMng/courseDetail/components/DetailDrawer.vue'
...
export default {
  ...
  methods: {
    ...
    editSubsection(item) {
      ...
      this.$refs['chapter-dialog'].ruleForm.content = item.content
