...
import { uploadSmallFile } from "@/api/edu/file";
    ...
    doUpload(files) {
      ...
      uploadSmallFile(uploadObj).then((res) => {
        ...
        if (res && res.flag && resData) {
          ...
          let filePath = resData;
          this.filePath = filePath;
          this.ruleForm.userAvatar = this.filePath;
