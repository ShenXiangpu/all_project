<template>
  <div class="app-container">
    ...
    <border-container class="marginBottom10" :lBCircle="lBCircle"
      :lSCircle="lSCircle" :rBCircle="rBCircle" :rSCircle="rSCircle" :height="15" :isShowTitle="false" :isBgShow="false">
      <template #content>
    ...
    <el-card>
      <!-- <template #header>
        ...
        <el-popconfirm title="确定删除吗？" @onConfirm="handleDeleteIds(ids)" onCancel="">
          <el-button type="danger" icon="el-icon-delete" slot="reference" :disabled="ids && ids.length === 0">删除
          </el-button>
        </el-popconfirm>
      ...
      <el-table ref="dataTableRef" v-loading="loading" :data="roleList" @selection-change="handleSelectionChange"
        ...
        <el-table-column label="角色名称" prop="cnName" min-width="150" align="center" />
        <el-table-column label="角色编码" prop="name" width="150" align="center" />
        ...
        <el-table-column label="操作" fixed="right" align="center" min-width="180">
          <template #default="scope">
            <el-button size="small" type="primary" class="editPrimary" @click.stop="showRoleMenuDialog(scope.row)">
              权限设置
            </el-button>
            <!-- <el-divider direction="vertical"></el-divider> -->
            <!-- <el-button size="small" type="primary" @click.stop="handleUpdate(scope.row)">
              修改
            </el-button>
            <el-divider direction="vertical"></el-divider>
    ...
    <el-dialog :title="dialog.title" :visible.sync="dialog.visible" @close="cancel" width="600px">
      <el-form ref="dataFormRef" :model="formData" :rules="formDataRules" label-width="150px">
        <el-form-item label="角色名称" prop="cnName">
          <el-input v-model="formData.cnName" style="width:300px" placeholder="请输入角色名称" maxlength="20" show-word-limit />
        </el-form-item>
        <!-- 权限标识 -->
        <el-form-item label="角色编码" prop="name">
          <el-input v-model="formData.name" style="width:300px" placeholder="请输入角色编码" maxlength="20" show-word-limit />
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="角色权限配置" :visible.sync="menuDialogVisible" width="500px" @close="closeMenuDialogVisible">
      <el-tree title="角色权限配置" ref="resourceRef" node-key="id" show-checkbox :data="menuList" :default-expand-all="true"
        :default-checked-keys="defaultCheckedKeys" :props="defaultProps" @check="handleRoleList">
      </el-tree>
      <template #footer>
