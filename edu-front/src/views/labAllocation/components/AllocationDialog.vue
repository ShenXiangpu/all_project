  ...
  >
    <div>
      <el-form
        ...
        class="ruleForm"
      >
        <el-form-item label="选择学校" prop="universityId">
          <el-select
        ...
        <el-form-item label="选择实验" prop="trialIdList">
          <border-container
          ...
          <el-card class="my-lab-card-body">
            <div>
              ...
              >
                ...
                <el-table-column
                  prop="oneTrialCourseHasUserCount"
                  align="center"
                  min-width="120"
                  label="实验人次"
                  show-overflow-tooltip
                >
                  <template slot-scope="scope">
                    <span class="">{{
                      scope.row.userCountInfo.oneTrialAllCourseFinish || 0
                    }}</span>
                  </template>
                </el-table-column>
                <el-table-column
      ...
      >
        <div class="app-container" style="overflow: auto; height: 90vh">
          <div class="drawer-title font20 primaryBgColor marginBottom20">
          ...
          <div class="drawer-richText">
            <edu-tinymce
              ref="edu-tinymce"
              class="edu-tinymce"
              :disabled="true"
              :value="trialDetail.trialDescription"
            ></edu-tinymce>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        trialIdList: [{ required: true, message: "请选择实验", trigger: "blur" }],
      },
      schoolList: [],
      trialDetail: {},
    };
  ...
  methods: {
    ...
    handleSelectionChange(val) {
      ...
      this.ruleForm.trialIdList = trialIdList;
    },
    queryCreateBy() {
    ...
    queryCourses() {
      getSchoolList("").then((res) => {
        this.schoolList = res && res.resData;
      });
    },
