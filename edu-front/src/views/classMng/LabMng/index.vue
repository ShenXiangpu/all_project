  ...
  <div class="app-container">
    ...
    <el-card class="marginTop10">
      ...
      <el-table :data="labsList" style="width: 100%">
        ...
        <el-table-column v-if="userRolesNames === '系统最高管理员'" prop="universityName" label="所属高校" min-width="180" align="center" show-overflow-tooltip>
        </el-table-column>
        ...
        <el-table-column prop="remark" label="描述" align="center" min-width="180">
        </el-table-column>
    ...
    <upload-file-dialog :updateFileInfo="updateFileInfo" :dialogStatus="dialogStatus" :loadding="fileUpLoading"
      ref="upload-file-dialog" @doUpload="doUpload" @handleClose="handleClose" :fileDialogVisible="fileDialogVisible" />
  </div>
</template>
