<template>
  <el-dialog :title="textMap[dialog.status]" :visible="dialog.visible" @close="cancel"
    :width="dialog.status != 'update' ? '80vw' : '40vw'">
        ...
        <div class="form-container marginBottom20">
          <el-form :inline="true" :model="searchForm" ref="searchForm" class="demo-form-inline">
            <el-form-item label="试题名称" prop="title" class="marginRight20">
              <el-input clearable placeholder="请输入试题名称" v-model="searchForm.title" class="" style="width: 200px;">
                <!-- <el-button slot="append" icon="el-icon-search" @click="handleQueryList"></el-button> -->
              </el-input>
            </el-form-item>
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button v-if="dialog.status != 'update'" :loading="homeworkSubLoading" type="primary"
        @click="submitForm('form')">确
        定</el-button>
      <el-button v-if="dialog.status == 'update'" :loading="homeworkSubLoading" type="primary"
        @click="submitForm('form')">修
        改</el-button>
