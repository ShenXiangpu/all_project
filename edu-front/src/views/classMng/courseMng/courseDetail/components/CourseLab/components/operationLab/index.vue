  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="计算资源" prop="recommendStandard">
        <el-select
          v-model="ruleForm.recommendStandard"
          class="el-form-input-edu"
          placeholder="请选择计算资源"
        >
          <el-option
            v-for="item in memoryAndCoreList"
            :key="item.id"
            :label="item.memoryAndCore"
            :value="item.memoryAndCore"
          ></el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="是否公开" prop="ofPublic">
        <el-switch
          class="switchStyle editSwitchStyle"
          v-model="ruleForm.ofPublic"
          active-text="是"
          inactive-text="否"
          active-color="#10abb9"
      ...
      <div class="flex">
        <el-form-item label="实验描述" prop="trialDescription">
          ...
          <div v-if="showTinymce" :style="{ width: `${tinymceWidth}px` }">
            <edu-tinymce
              ref="edu-tinymce-trial"
              :value="ruleForm.trialDescription"
            ></edu-tinymce>
          </div>
        </el-form-item>
        <el-form-item label="实验视频" prop="trialVideoPath">
          <div class="trialVideoPath" v-if="trialId && ruleForm.trialVideoPath">
            <div class="meng flex justify-center align-center font20">
              <i
                class="el-icon-zoom-in marginRight10 pointer"
                @click="showVideo"
              ></i>
          ...
          <el-card class="el-card-lab">
            ...
            <div>
              ...
              <el-form-item
                class="marginBottom20"
                label="Lab名称"
                prop="coverImageLabName"
              >
                <el-input
                  v-model="ruleForm.coverImageLabName"
                  placeholder="请输入Lab名称"
                  class="el-form-input-edu"
                ></el-input>
              </el-form-item>
              ...
              <el-form-item
                class="marginBottom20"
                label="展示作者"
                prop="coverImageDisplayAuthor"
              >
                <el-switch
                  class="switchStyle editSwitchStyle"
                  v-model="ruleForm.coverImageDisplayAuthor"
                  active-text="是"
                  inactive-text="否"
                  active-color="#10abb9"
                  inactive-color="#A6A6A6"
              ...
              <el-form-item label="选择图片" prop="coverImageStage">
                <img-choose
                  :coverImageStage="ruleForm && ruleForm.coverImageStage"
                  @imgClick="imgClick"
                ></img-choose>
              </el-form-item>
            </div>
            ...
            <div class="show-container">
              ...
              <div class="show-info">
                <div
                  ...
                  v-if="ruleForm.coverImageTrialTypeName"
                >
                  【{{ ruleForm.coverImageTrialTypeName }}】
                </div>
                <el-popover placement="top" trigger="hover">
                  ...
                  <div
                    slot="reference"
                    class="view-text marginBottom20"
                ...
                <el-popover
                  v-if="ruleForm.coverImageLabName"
                  placement="top"
                  trigger="hover"
                >
                  <div>
                  ...
                  <div
                    v-if="ruleForm.coverImageLabName"
                    slot="reference"
                    class="view-text lab-container marginBottom20"
                  >
                    {{ ruleForm.coverImageLabName }}
                  </div>
                </el-popover>
                <el-popover
                  v-if="ruleForm.coverImageTaskName"
                  placement="top"
                  trigger="hover"
                >
                  <div>
              ...
              <div v-if="ruleForm.coverImageDisplayAuthor" class="show-text">
                导师：{{ ruleForm.createByName || name }}
              </div>
            </div>
          </el-card>
        </div>
      ...
      <el-form-item label="上传lab" prop="labList">
        <lab-choose
          :labList="ruleForm.labList"
          @getLabList="getLabsList"
          @removeLabList="getLabsList"
        ></lab-choose>
      </el-form-item>
      ...
      <el-form-item>
        <el-button
          ...
          >{{ trialId && trialId != 0 ? "立即修改" : "立即创建" }}</el-button
        >
...
import { handleTrial, oneDetail, uploadFile } from "@/api/edu/labCenter";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        //   { required: true, message: '请输入实验描述', trigger: 'blur' }
        // ],
        coverImageDisplayAuthor: [{ required: true }],
        coverImageStage: [
  ...
  methods: {
    ...
    submitForm(formName) {
      ...
      this.ruleForm.trialDescription =
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.ruleForm.coverImageDisplayAuthor = coverImageDisplayAuthor
            ? 1
            : 0;
          /**
           *
