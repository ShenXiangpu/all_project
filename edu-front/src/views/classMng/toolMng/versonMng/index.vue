  ...
  <div class="app-container">
    ...
    <el-card class="marginTop10">
      ...
      <el-table :data="toolVersionList" style="width: 100%">
        ...
        <el-table-column prop="toolVersion" label="工具版本" min-width="180" align="center">
        </el-table-column>
        <el-table-column label="环境变量" width="180" align="center">
          <template #default="scope">
            <el-button size="small" type="success" class="editSuccess" @click.stop="lookDetail(scope.row)">
              查看
            </el-button>
          </template>
        </el-table-column>
        <el-table-column label="操作" align="center" min-width="180" fixed="right">
          <template #default="scope">
            <el-button size="small" type="primary" class="editPrimary" @click.stop="handleUpdate(scope.row, '工具')">
              修改
            </el-button>
    ...
    <el-dialog :title="textMap[dialog.status]" :visible.sync="dialog.visible" @close="cancel" class="dialog1">
      <el-form ref="toolVersionForm" :model="toolVersionForm" :rules="toolVersionRules" class='version'>
        <el-row>
          <el-col v-if="textMap[dialog.status] !== '查看'" :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-form-item label="工具版本" prop="toolVersion">
              <el-input class="el-form-input-edu" v-model="toolVersionForm.toolVersion"
                placeholder="请输入工具版本"></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-form-item label="环境变量" prop="environments">
              <el-table :data="toolVersionForm.environments" height="300px" border
                class="el-table-edu el-form-input-edu">
                <el-table-column type="index" label="序号" width="55" align="center">
                </el-table-column>
                <el-table-column prop="variableName" label="变量名" min-width="100" align="center">
                </el-table-column>
                <el-table-column prop="variableValue" label="变量值" min-width="180" align="center">
                </el-table-column>
                <el-table-column v-if="textMap[dialog.status] !== '查看'" fixed="right" label="操作" align="center">
                  <template #default="scope">
                    <el-popconfirm title="确定删除吗？" @onConfirm="handleDeleteVersion(scope)" onCancel="">
                      <el-button size="small" type="danger" class="editDanger" slot="reference">
                        删除
                      </el-button>
                    </el-popconfirm>
          ...
          <el-col v-if="textMap[dialog.status] !== '查看'" style="margin:0 auto;text-align: center;">
            <el-button type="primary" @click="handleAdd1">添加环境变量</el-button>
          </el-col>
      ...
      <span v-if="textMap[dialog.status] !== '查看'" slot="footer" class="dialog-footer">
    ...
    <el-dialog :title="textMap1[dialog.status]" :visible.sync="dialog1.visible" @close="cancel1" class="dialog">
      <el-form ref="envForm" class="versions" :model="envForm" :rules="envFormRules">
        <el-row>
          <el-col :xs="24" :sm="24" :md="24" :lg="22" :xl="24">
            <el-form-item label="变量名" prop="variableName1">
              <el-input class="el-form-input-edu" v-model="envForm.variableName1" placeholder="请输入变量名"></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-form-item label="变量值" prop="variableValue1">
              <el-input class="el-form-input-edu" v-model="envForm.variableValue1" placeholder="请输入变量值"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
