<template>
  <div class="app-container">
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="ruleForm">
      ...
      <el-form-item label="关联课程" v-if="trialId && !pub">
        <el-input v-model="courseName" :disabled="true" class="el-form-input-edu"></el-input>
      </el-form-item>
          ...
          <el-card class="el-card-lab">
            ...
            <div>
              ...
              <el-form-item class="marginBottom20" label="展示作者" prop="coverImageDisplayAuthor">
                <el-switch class="switchStyle editSwitchStyle" v-model="ruleForm.coverImageDisplayAuthor"
                  active-text="是" inactive-text="否" active-color="#10abb9" inactive-color="#A6A6A6">
                </el-switch>
              </el-form-item>
            ...
            <div class="show-container">
              ...
              <div class="show-info">
                ...
                <el-popover placement="top" trigger="hover">
                  ...
                  <div slot="reference" class="view-text marginBottom20" style="display: block; width: 90%" v-if="
                    ruleForm &&
                    ruleForm.tools &&
                    ruleForm.tools[0] &&
                    ruleForm.tools[0].edaTools &&
                ...
                <el-popover v-if="ruleForm.coverImageLabName" placement="top" trigger="hover">
                  ...
                  <div v-if="ruleForm.coverImageLabName" slot="reference"
...
import { handleTrial, oneDetail, uploadFile, oneTrialTempInfo } from "@/api/edu/labCenter";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        recommendStandard: [
          { required: true, message: "请选择计算资源", trigger: "blur" },
        ],
        type: [
          {
            type: "array",
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          let coverImageDisplayAuthor = ruleForm.coverImageDisplayAuthor;
          ruleForm.coverImageDisplayAuthor = coverImageDisplayAuthor
            ? 1
            : 0;
          /**
           *
           ...
           * 2. 课程id为空，则默认公开
           */
          let ofPublic = ruleForm.ofPublic;
          ruleForm.ofPublic = ofPublic ? 1 : 0;
          ...
          handleTrial(data)
            .then((res) => {
              if (res && res.flag) {
                ...
                ruleForm.ofPublic == 1
                  ? (this.ruleForm.ofPublic = true)
                  : (this.ruleForm.ofPublic = false);
                ruleForm.coverImageDisplayAuthor == 1
                  ? (this.ruleForm.coverImageDisplayAuthor = true)
                  : (this.ruleForm.coverImageDisplayAuthor = false);
                this.btnLoading = false;
              }
            })
            .finally(() => {
