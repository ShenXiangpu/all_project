      ...
      <el-row :gutter="20">
          ...
          >
            <template #content>
              <div class="padding20 left-container">
                <div class="font18 fontW7 marginBottom20">底层架构：{{ vmEnvDetail.architectureList[0] }}</div>
                <div
        ...
        <el-col :span="18" :xs="18" :sm="18" :md="18" :lg="18" :xl="18">
          <el-row :gutter="20">
            ...
            <el-col :span="12" :xs="16" :sm="16" :md="16" :lg="16" :xl="12">
              <border-container
                  ...
                  <div class="padding20 font14 lab-container">
                    <el-row :gutter="20">
                      <el-col :span="12" :xl="12" class="marginBottom10">
                        实操云名称：{{ vmEnvDetail.vmName }}
                      </el-col>
                      <el-col :span="12" :xl="12" class="marginBottom10">
                        实操云ID：{{ vmEnvDetail.vmId }}
                      </el-col>
                      ...
                      <el-col :span="12" :xl="12" class="marginBottom10">
                        底层架构：{{ vmEnvDetail.architectureList[0] }}
                      </el-col>
                    </el-row>
                  </div>
                </template>
            ...
            <el-col :span="8" :xs="8" :sm="8" :md="8" :lg="8" :xl="12">
              <border-container
                class="border-container"
                title="文件信息"
                subSubTitle="<span class='primaryColoro font14'> (文件在/home目录下)</span>"
                :height="15"
                :isBgShow="false"
              >
                <template #content>
                  <div class="padding20 lab-container">
                    <el-row :gutter="10">
                      <el-col class="marginBottom20 font14" :xl="24">
                        ...
                        <el-tooltip
                          v-for="item in vmEnvDetail.libInfoList"
                          :key="item.id"
                          class="item"
                          effect="define"
                          :content="item.remark"
