<template>
  <div :class="!disabled ? '' : 'edu-disabled'" class="tinymce-tests">
    <editor
      v-model="content"
      :disabled="disabled"
      :api-key="apiKey"
...
export default {
  ...
  mounted() {
    // const tinymce = document.getElementsByClassName("tinymce-tests") || document.getElementsByClassName("edu-disabled");

    // const { setWatermark, clear } = useWatermark(tinymce[0]);
    // setWatermark("测试");
  },
  data() {
    return {
