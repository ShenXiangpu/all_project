<template>
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialog.visible" width="30%" @close="handleClose">
        <el-form ref="form" :model="form" label-width="120px">
            <el-form-item v-if="dialogStatus == 'create'" label="文件">
                <el-upload class="upload-demo" ref="upload" action :http-request="doUpload" :on-remove="handleRemove"
                    :file-list="fileList" :before-upload="beforeAvatarUpload" :on-change="handleChange" :auto-upload="true"
                    :limit="2">
                    <el-button slot="trigger" size="small" type="primary" icon="el-icon-plus">上传文件</el-button>
                </el-upload>
            </el-form-item>
            <el-form-item label="重命名">
                <el-input style="width: 80%;" placeholder="请输入文件重命名" v-model="form.fileRename"></el-input>
            </el-form-item>
            <el-form-item label="描述">
                <el-input style="width: 80%;" type="textarea" :rows="2" placeholder="请输入文件描述信息"
                    v-model="form.remark"></el-input>
            </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
            <el-button @click="handleClose">取 消</el-button>
            <el-button type="primary" @click="submitUpload" :loading="loadding">确 定</el-button>
        </span>
    </el-dialog>
</template>
