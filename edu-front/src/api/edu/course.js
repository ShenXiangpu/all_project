...
export function getCourseList(data) {
    ...
    if (data && data.params) {
        ...
        }if (paramData.universityName) {
            params += `&universityName=${paramData.universityName}`;
        }

    }
    return request({
        url: `edu/sso-service/sso/course/v2/getCourseList?current=${data && data.page && data.page || 1}&size=${data && data.limit && data.limit || 10}${params}`,
        method: 'post'
    })
}
...
export function getUsersForCourse(data) {
    ...
    return request({
        url: `edu/sso-service/sso/course/v2/getUsersForCourse?edu=true&roleName=学生${params}`,
        method: 'get'
    })
}
 ...
 */
 ...
 export function getHomeworkList(data) {
    ...
    return request({
        url: `edu/sso-service/sso/homework/v2/getHomeworkList?pageNum=${data.page}&pageSize=${data.limit}${params}`,
        method: 'get'
    })
}
...
export function getScoreLevel() {
    ...
    return request({
        url: `edu/sso-service/sso/dictionary/v2/getScoreLevel`,
        method: 'get',
    })
}
...
export function getAcademicYear() {
    ...
    return request({
        url: `edu/sso-service/sso/course/v2/getAcademicYearForHomeWork`,
        method: 'get',
    })
}
...
export function getCourseForHomeWork(data) {
    ...
    return request({
        url: `edu/sso-service/sso/course/v2/getCourseForHomeWork?year=${data}`,
        method: 'get',
    })
}
...
export function getCourseUserPage(data) {
    ...
    return request({
        url: `edu/sso-service/sso/course/v2/getCourseUserPage?courseId=${data.courseId || 0}&pageNum=${data.page || 1}&pageSize=${data.limit || 10}${params}`,
        method: 'get'
    })
}
...
export function oneCourseRelTrialList(data) {
    ...
    return request({
        url: `edu/sso-service/trial/oneCourseRelTrialList?courseId=${data && data.courseId}${params}`,
        method: 'get',
    })
}
...
export function getStudentScheduleCount(data) {
    ...
    return request({
        url: `edu/sso-service/sso/course/v2/getStudentScheduleCount?courseId=${data && data.courseId}`,
        method: 'get',
    })
}
...
export function getSectionFileStreamById(data) {
    return request({
        url: `edu/sso-service/section/getSectionFileStreamById?id=${data && data.id}`,
        method: 'get',
        responseType: 'Blob'
    })
}
...
///university/getUniversityForSearch

/**
 * 获取高校下拉列表
 * @returns
 */
export function getUniversityForSearch() {
    return request({
        url: `edu/sso-service/university/getUniversityForSearch`,
        method: 'get',
    })
}
