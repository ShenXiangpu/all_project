...
export function handleTrial(data) {
  ...
  let pub = data && data.pub || false
  let str = "edu/sso-service/trial/trial";
  if(pub) {
    str = "edu/sso-service/trial/trial/v3";
  }else {
...
export function getMyTrialList(data) {
  ...
  return request({
    url: `edu/sso-service/trial/page/center?pageSize=${
      (data && data.limit) || 10
...
export function oneDetail(id) {
  return request({
    url: `edu/sso-service/trial/oneDetail?trialCourseId=${id}`,
    method: "get",
  });
}
...
export function deleteOneRel(data) {
  return request({
    url: `edu/sso-service/trial/delOneTrial?trialId=${data && data.id}`,
    method: "delete",
  });
}
