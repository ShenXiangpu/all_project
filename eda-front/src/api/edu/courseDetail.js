...
export function getClassNameForHomeWork() {
    ...
    return request({
        url: `${context1}/sso-service/sso/course/v2/getClassNameForHomeWork`,
        method: 'get',
    })
}
...
export function getUsersForCourse(data) {
    ...
    return request({
        url: `${context1}/sso-service/sso/course/v2/getUsersForCourse?edu=true${params}`,
        method: 'get'
    })
}
...
export function getCourseUserNoVm(data) {
    ...
    return request({
        url: `${context1}/sso-service/sso/course/v2/getCourseUserNoVm?courseId=${data.courseId}${params}`,
        method: 'get'
    })
}
...
export function delCourse(data) {
    return request({
        url: `${context1}/sso-service/sso/course/v2/delCourse?id=${data && data.id}`,
        method: 'delete',
    })
}
