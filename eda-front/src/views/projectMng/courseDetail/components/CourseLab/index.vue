<template>
    <div>
                    ...
                    <el-popover placement="right" trigger="click">
                        <div>
                            <el-button type="primary" size="small" style="border: none;" class="primaryBgColor"
                                @click="handleAddLab('operation')">自定义实验</el-button>
                            <el-button size="small" class="primaryBgColor" type="primary" style="border: none;"
                                @click="handleAddLab('square')">实验广场添加</el-button>
                        </div>
        ...
        <add-lab-dialog @queryList="queryList" ref="add-lab-dialog" :courseId="courseId"></add-lab-dialog>
    </div>
</template>
...
export default {
    ...
    name: "CourseLab",
    components: {
        BorderContainer, LabList, Pagination, ToolsDetail, LabDetail,AddLabDialog
    },
    props: {
        courseId: {
            default: '0' | 0,
