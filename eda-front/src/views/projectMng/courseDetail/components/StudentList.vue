<template>
  <div>
    <el-card
      ...
      v-permission="['sso:project:getUsersInProject']"
    >
    ...
    <el-card>
      <template #header>
        <div class="flex justify-between align-center">
          <div v-permission="['sso:project:addUser2Project']">
            <el-button type="primary" icon="el-icon-plus" @click="handleAdd"
              >添加成员</el-button
            >
          </div>
          <div class="flex" v-permission="['sso:project:getApplyList']">
            <el-badge :value="applyCount" class="item">
              <el-button type="primary" @click="handleJoinList"
                >申请列表</el-button
              >
            </el-badge>
          </div>
      ...
      <div>
        <el-table :data="studentList" border style="width: 100%" height="450">
          <el-table-column
            type="index"
            label="序号"
            width="55"
          ...
          >
            <template #default="scope">
              <el-tag
                class="online"
                v-if="scope && scope.row && scope.row.systemStatus"
              >
                在线
              </el-tag>
              ...
              <el-tag class="outline" type="info" v-else> 离线 </el-tag>
            </template>
          </el-table-column>
          <el-table-column
            prop="vmStatus"
          ...
          >
            <template #default="scope">
              <el-tag
                class="online"
                v-if="scope.row.vmName && scope.row.vmStatus"
              >
                在线
              </el-tag>
              <!-- <el-button size="mini" type="primary"
          ...
          <el-table-column
            ...
            min-width="100"
            fixed="right"
            v-if="checkPermission(['sso:project:removeUser'])"
          >
            <template #default="scope">
              <el-popconfirm
                title="确定删除吗？"
      ...
      <el-row :gutter="20">
        <el-col :span="6" :xs="24" :sm="24" :md="24" :lg="10" :xl="10">
          <el-form
            ...
            label-width="100px"
          >
            <el-form-item label="成员" prop="userIds" id="userIds">
    ...
    <join-list-dialog ref="joinList" :projectId="courseId"></join-list-dialog>
  </div>
</template>
...
import { getUsersNotInCourse, getApplyList } from "@/api/edu/projectMng";
...
export default {
  ...
  props: {
    ...
    applyCount: { default: 0 | "0", type: Number | String },
  },
  data() {
    return {
  ...
  methods: {
    //打开申请列表
    handleJoinList() {
      let joinList = this.$refs["joinList"];
      joinList.dialogVisible.visible = true;
      joinList.queryApplyList();
    },
