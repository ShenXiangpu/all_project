  ...
  <div class="app-container">
      ...
      >
        <div v-show="activeValue == 0">
          ...
          <el-form-item label="数据盘" prop="diskSizeMB">
            ...
            &nbsp;GB<span
              style="color: #f00; margin-left: 30px"
              v-if="!isCanExpansion"
          ...
          <el-divider></el-divider>
          <el-form-item label="选择IP" prop="ips">
          ...
          <el-divider></el-divider>
          <el-form-item label="选择PDK" prop="pdks">
          ...
          <div class="text-center">
            ...
            <el-button v-if="!vmId" type="primary" @click="next"
              >下一步</el-button
            >
    ...
    >
      <el-table
        ...
        :data="labsList"
        ref="multipleTable"
        @selection-change="handleSelectionLab"
        style="width: 100%"
        height="300"
      >
...
import PDKDialog from "../components/PDKDialog.vue";
  ...
  methods: {
    ...
    submitForm() {
      ...
      let createVMInfo = {
        ...
        // userCounts: this.ruleForm.userCounts,
          ...
          createVM(createVMInfo)
            .then((res) => {
              if (res && res.resData) {
                ...
                let id = this.groupId;
                this.$router.push({
                  path: "/classMng/cloudEnvironment",
                  query: { id },
                });
              } else {
