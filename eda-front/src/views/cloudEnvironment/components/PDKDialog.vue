<template>
  ...
  >
    ...
    >
      ...
      <div class="fontW7 text-center padding20">
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="getPdkList">确 定</el-button>
    </span>
  </el-dialog>
</template>

<script>
import { getOenList } from "@/api/edu/pdk";
export default {
  name: "",
  components: {},
  created() {
