<template>
  <div class="app-container">
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="license列表" name="first">
        <div v-if="activeName == 'first'">
          <border-container
            v-permission="['license:getLicenseServers']"
          ...
          <el-card class="marginTop10">
            <template
              #header
              v-if="checkPermission(['license:addLicenseServer'])"
            >
              <el-button
                type="primary"
                icon="el-icon-plus"
            ...
            <el-table :data="licensesList" style="width: 100%">
              ...
              >
                <template #default="scope">
                  <el-switch
                    :disabled="!checkPermission(['license:changeStatus'])"
                    class="switchStyle"
                    @change="
                      handleLicenseStatus(
                        scope.row.id,
              ...
              <el-table-column
                v-if="
                  checkPermission([
                    'license:editLicenseServer',
                    'license:deleteLicenseServer',
                  ])
                "
                label="操作"
                align="center"
              ...
              >
                <template #default="scope">
                  <el-button
                    v-permission="['license:editLicenseServer']"
                    size="small"
                    type="primary"
                  ...
                  >
                    <el-button
                      v-permission="['license:delLicenseServer']"
                      size="small"
                      type="danger"
                      class="editDanger"
                      slot="reference"
      ...
      <el-tab-pane label="工具列表" name="third">
        <div v-if="activeName == 'third'">
          ...
          <el-card class="marginTop10">
            <template #header v-if="checkPermission(['tool:addTool'])">
            ...
            <el-table :data="toolsList" style="width: 100%">
              ...
              <el-table-column prop="status" label="工具状态" align="center">
                <template #default="scope">
                  <el-switch
                    :disabled="!checkPermission(['tool:changeStatus'])"
                    class="switchStyle"
                    @change="
                      handleToolStatus(
                        scope.row.id,
              ...
              >
                <template #default="scope">
                  ...
                  <div v-if="scope.row.useResourceType == '3'">内存型</div>
                  <div v-if="scope.row.useResourceType == '2'">计算型</div>
                </template>
              </el-table-column>
              <el-table-column
                label="操作"
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <el-form-item label="占用资源类型" prop="useResourceType">
              ...
              >
                ...
                <el-radio-button :label="2">计算型</el-radio-button>
...
export default {
  ...
  methods: {
    ...
    goToDetail(row) {
      const { id } = row;
      this.$router.push({ path: "/classMng/versonMng", query: { id } });
    ...
    async handleDelete(row) {
      console.log(row);
      const { id } = { ...row };
      if (this.activeName == "first" && this.textValue == "license") {
