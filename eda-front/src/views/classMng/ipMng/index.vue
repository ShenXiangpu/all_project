<template>
  <div class="app-container">
    ...
    <el-card class="marginTop10">
      <template #header v-if="checkPermission(['file:ip:uploadOne'])">
      ...
      <el-table :data="labsList" style="width: 100%">
        ...
        <el-table-column
          v-if="checkPermission(['file:ip:modifyRemark', 'file:ip:delOne'])"
          label="操作"
          fixed="right"
          align="center"
          min-width="180"
        >
          <template #default="scope">
            <el-button
              v-permission="['file:ip:modifyRemark']"
              size="small"
              type="primary"
