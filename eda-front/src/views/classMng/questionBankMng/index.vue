    ...
    <div class="app-container">
        <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="题库列表" name="first">
                <question-bank ref="questionBank" @updateQuestionBank="updateQuestionBank" :directionList="directionList"
                    @handleAdd="handleAddQuestionBank"></question-bank>
                <question-dialog :ruleForm="ruleForm" :status="status" @submitQuestion="submitQuestion"
                    :directionList="directionList" @handleClose="handleQuesTionClose"
                    :dialogVisible="dialogQuestionVisible"></question-dialog>
            </el-tab-pane>
...
import { getTeachDirectionList, addOrUpdataQuestionBank, getQuBankList } from '@/api/edu/question'
export default {
