    ...
    <div>
        <div class="marginBottom20">
            <el-upload class="upload-demo" ref="upload" multiple :show-file-list="false" action :http-request="doUpload"
                ...
                <el-button style="width: 200px;font-size: 16px;" class="marginRight20" slot="trigger" type="primary">选取文件</el-button>
        ...
        <div>
            <el-button :loading="loading" @click="submitUpload" type="success" style="width: 200px;font-size: 16px;"
