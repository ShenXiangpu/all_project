                ...
                <div v-show="activeValue == 0">
                    ...
                    <el-form-item label="镜像" prop="region">
                        ...
                        <div class="flex" style="width: 600px;padding: 0 20px 0 0px; margin-top:20px">
                            ...
                            <el-select style="width: 300px;margin-right:20px" v-model="value2" placeholder="请选择">
                                <el-option id="CentOSss" label="64位" value="64位">
                                </el-option>
                            </el-select>
                    ...
                    <el-form-item label="数据盘" prop="diskSizeMB">
                        <el-popover placement="top-start" title="容量范围" width="200" trigger="hover" content="">
                            <div>
                                ...
                                <div v-if="vmId" style="color: #f00;">*扩容磁盘时，请提前备份重要数据</div>
                            </div>
                            <el-input-number :disabled="!isCanExpansion" slot="reference" v-model="ruleForm.diskSizeMB"
                                ...
                                :min="Number(rebackDiskSizeMB)" :max="1024" :step="1"
                                :step-strictly="true"></el-input-number>
                        </el-popover> &nbsp;GB <span style="color: #f00;margin-left: 30px;"
                            v-if="!isCanExpansion">*存在设计云快照，如需扩容，请删除设计云快照</span>
                    ...
                    <el-form-item label="快照服务">
                        ...
                        <el-form-item label="快照保留时间" prop="region">
                            保留<el-input-number id="region" v-model="ruleForm.retentionDays"
                                ...
                                @change="handleRetentionDaysChange" :min="1" :max="7"></el-input-number>天后自动删除
                        </el-form-item>
                    ...
                    <el-form-item label="设计云人数" prop="maxUserCounts">
                        人数上限 &nbsp;<el-input-number id="maxUserCounts" v-model="ruleForm.maxUserCounts"
                            ...
                            style="color:#f00;font-size:12px">注意：该处为每台设计云支持的使用人数范围，最小值{{ maxUserCounts }}，最大值为10</span>
                    </el-form-item>
                    <el-divider></el-divider>
...
export default {
    ...
    created() {
        ...
        if (maxUserCounts && diskSizeMB) { //说明是批量修改
    ...
    methods: {
        ...
        confirmUpdate() {
            ...
            if (this.vmId) {
                ...
                this.loading = true
                this.isShowDialog = false
                reConfigBatch({ updateVMInfo, vmIds: this.vmIds }).then(res => {
                    if (res && res.flag) {
                        this.$message.success("修改成功")
                        this.$router.back()
                        this.loading = false
