<template>
  <div class="app-container">
    <border-container
      v-permission="['file:pdk:pageList']"
    ...
    <el-card class="marginTop10">
      <template #header v-if="checkPermission(['file:pdk:uploadOne'])">
      ...
      <el-table :data="labsList" style="width: 100%">
        ...
        <el-table-column
          v-if="checkPermission(['file:pdk:modifyRemark', 'file:pdk:delOne'])"
          label="操作"
          fixed="right"
          align="center"
          min-width="180"
        >
          <template #default="scope">
            <el-button
              v-permission="['file:pdk:modifyRemark']"
              size="small"
              type="primary"
