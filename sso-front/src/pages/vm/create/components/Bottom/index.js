...
class Bottom extends PureComponent {
  ...
  onNext = () => {
    const { onNext, currentStep } = this.props;
    const data = {
  ...
  onPrevious = () => {
    const { onPrevious, currentStep } = this.props;
    const data = {
      currentStep: currentStep - 1
    }
    onPrevious(data);
          ...
          <Form  {...formItemLayout} layout="horizontal">
            <Row>
              ...
              <Col span={6} className={styles.col3}>
                {currentStep === 0 &&
                  <Button type="primary" className={styles.btn} onClick={this.onNext}>
                    下一步：网络
                  </Button>
                }
                {currentStep === 1 &&
                  <div>
                    ...
                    <Button type="ghost" className={styles.btn} style={{ marginRight: 10 }} onClick={this.onPrevious}>
                      上一步
                    </Button>
                  </div>
                }
