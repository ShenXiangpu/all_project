...
#DEFINE Top_metal MTT	//Valid value is:{ TM, MTT };	
...
#DEFINE MIM one_mask		//Valid value is:{ one_mask, two_mask, stack_mim }
...
//   <Choice 8> Seal Ring
//****************************************************
#DEFINE SRCK_FOR_11		NO			//Valid value is:{ YES, NO}
...
#DEFINE SRCK_FOR_13		YES			//Valid value is:{ YES, NO}
...
AA_11a {
@ Min. AA density (including dummy AA)is 20%. Density check window size: 500µm*500µm with step size: 250µm.
...
AA_11b {
@ Max. AA density (including dummy AA)is 80%. Density check window size: 500µm*500µm with step size: 250µm.
@ Waive RESNW, Metal Fuse, L Mark, LOGO and Inductor.
@ DRC check with the said window size and rule number and highlight as X. Y = X not (RESNW or Metal Fuse or L MARK or LOGO or INDMY), Z= (Y area)/(250*250)  
@ If Z > 25%, highlight Y for AA density inside of Y that cannot meet of rule value requirement.
  AA_ALL= AAi OR AADUM
...
MTT_1a{
@ MTT max. width that is not required metal slot (exclude DUPMK1 region and MTT AND PA pattern).	¿	30	µm
...
@DRC doesn¿t check the space under the same INDMY region.
@DRC doesn¿t check if the Inductor MTT is connected with other MTT through Mn(n=1~7)/TMn(n=1~2)/ALPA conductor layers..	¿	30	µm
...
@ Two Via areas whose space is within 0.52µm are considered to be in the same array.
...
@For non-SMIC standard seal ring design, SMIC can¿t guarantee the seal ring quality. It¿s strongly recommended to qualify in SMIC before it used in product tape-out.	
