...
const options = {
    ...
    chunkSize: 5 * 1024 * 1024,  // 如果要分片，分多大一片？ 默认大小为5M(5*1024*1024).
...
class LargeUploader extends React.Component {
    ...
    createWebUploaderInterface() {
        ...
        const { uploadUrl, formData, accept } = this.props;
    ...
    handleUploadAccept = (file, ret) => {
        ...
        console.log('ret:', ret);
        if (ret.flag) {
            return ret.resData.uploadSuccess
        }
        return false;
    }
