...
class BasicInfoConfig extends PureComponent {
  ...
  get needProps() {
    const { form, mpw, dispatch, onChange, RequirementModel, neeColProps, neeformItemLayout, reviewLayout, leftReadOnly,
      rightReadOnly, } = this.props
        ...
        <Form>
          ...
          <div className={styles.btn}>
            <Form.Item wrapperCol={{ span: 24, offset: 5 }}>
              ...
              {showUpdate && <><Button type="primary" onClick={(e) => this.handleSubmit(e, 0, id)} >修改</Button>  &nbsp;&nbsp; <Button onClick={(e) => this.reBackList(e, '1')} >取消</Button></>}
              {showReview && isDetail &&
                <>
